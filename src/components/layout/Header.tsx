          ...
          <div className="flex items-center justify-end gap-3 ml-auto">
            <div className="hidden lg:flex items-center gap-3">
              ...
              <button
                ...
                className="w-10 h-10 rounded-full bg-brand-white/10 hover:bg-brand-white/20 backdrop-blur-sm flex items-center justify-center border border-brand-white/10 hover:border-brand-white/30 transition-all duration-300 relative"
